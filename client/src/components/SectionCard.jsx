    ...
    <div className="bg-white rounded-xl shadow p-4">
      ...
      <div className="mt-3 grid gap-3 md:grid-cols-2">
        {section.resources?.map((r, idx) => (
          <a key={idx} href={r.link} target="_blank" rel="noreferrer" className="border rounded p-3 hover:bg-gray-50 flex items-center gap-3">
            {r.img ? (
              <img src={r.img} alt={r.description || 'resource'} className="w-12 h-12 object-cover rounded" />
            ) : (
