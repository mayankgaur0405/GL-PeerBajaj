      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            <input 
              className="w-full rounded-lg px-3 py-2 pr-10 bg-white dark:bg-slate-800/80 border border-slate-300 dark:border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/60 text-slate-900 dark:text-slate-100 placeholder-slate-400" 
